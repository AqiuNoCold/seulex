...
{
       0,     0,     3,     5,    11,    13,    15,    17,    22,    24,
      25,    27,    28,    30,    33,    37,    39,    43,    45,    49,
      51,    53,    56,    58,    60,    62,    64,    67,    69,    77,
      83,    87,    90,    92,    94,    98,   102,   106,   110,   114
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      24,     0,    -1,    25,    -1,    26,     9,    20,    21,    27,
      -1,     6,    -1,     7,    -1,     8,    -1,    13,    28,    29,
      14,    -1,    30,    -1,    -1,    35,    -1,    -1,    31,    -1,
      30,    31,    -1,    26,    32,    12,    -1,    33,    -1,    32,
      22,    33,    -1,     4,    -1,     4,    15,    34,    -1,    40,
      -1,    36,    -1,    35,    36,    -1,    37,    -1,    27,    -1,
      38,    -1,    39,    -1,    40,    12,    -1,    12,    -1,    10,
      20,     5,    22,    40,    21,    12,    -1,    10,    20,     5,
      21,    12,    -1,    11,    40,    12,    -1,    11,    12,    -1,
       4,    -1,     3,    -1,    40,    16,    40,    -1,    40,    17,
      40,    -1,    40,    18,    40,    -1,    40,    19,    40,    -1,
       4,    15,    40,    -1,    20,    40,    21,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint16 yyrline[] =
{
       0,   253,   253,   261,   269,   272,   275,   281,   289,   292,
     298,   301,   307,   311,   318,   326,   330,   337,   341,   349,
     355,   359,   366,   370,   374,   378,   385,   389,   395,   400,
     407,   411,   417,   421,   427,   434,   441,   448,   455,   462
};
#endif
...
static const char *const yytname[] =
{
  ...
  "STRING_LITERAL", "INT", "CHAR", "VOID", "MAIN", "PRINTF", "RETURN",
  "SEMICOLON", "LBRACE", "RBRACE", "'='", "'+'", "'-'", "'*'", "'/'",
  "'('", "')'", "','", "$accept", "program", "main_function",
  "type_specifier", "compound_statement", "opt_declaration_list",
  "opt_statement_list", "declaration_list", "declaration",
  "init_declarator_list", "init_declarator", "initializer",
  "statement_list", "statement", "expression_statement",
  "printf_statement", "return_statement", "expression", 0
};
#endif
...
{
       0,     4,     5,     6,     0,     2,     0,     1,     0,     0,
       0,     9,     3,     0,    11,     8,    12,    17,     0,    15,
      33,    32,     0,     0,    27,     0,    23,     0,    10,    20,
      22,    24,    25,     0,    13,     0,    14,     0,     0,     0,
      31,     0,     0,     7,    21,    26,     0,     0,     0,     0,
      18,    19,    16,    38,     0,    30,    39,    34,    35,    36,
      37,     0,     0,    29,     0,     0,    28
};
...
{
      -1,     4,     5,    13,    26,    14,    27,    15,    16,    18,
      19,    50,    28,    29,    30,    31,    32,    33
};
...
{
      60,   -24,   -24,   -24,     3,   -24,    -8,   -24,   -11,    -7,
       9,    60,   -24,    29,     7,    60,   -24,    23,    -6,   -24,
     -24,    26,    20,     1,   -24,    25,   -24,    55,     7,   -24,
     -24,   -24,   -24,    18,   -24,    25,   -24,    29,    25,    38,
     -24,    30,    34,   -24,   -24,   -24,    25,    25,    25,    25,
     -24,    46,   -24,    46,   -14,   -24,   -24,    13,    13,   -24,
     -24,    32,    25,   -24,    40,    42,   -24
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -24,   -24,   -24,    70,    50,   -24,   -24,   -24,    56,   -24,
      35,   -24,   -24,    45,   -24,   -24,   -24,   -23
};
...
{
      41,     8,    42,     7,    20,    21,    36,    61,    62,     9,
      20,    21,    51,    40,    10,    53,    37,    22,    23,    24,
      11,    25,    11,    57,    58,    59,    60,    25,    20,    21,
      45,    48,    49,    17,    46,    47,    48,    49,    35,    64,
      39,    38,    55,    54,    63,    25,    46,    47,    48,    49,
      46,    47,    48,    49,    66,    56,    46,    47,    48,    49,
      12,    65,    46,    47,    48,    49,     1,     2,     3,    43,
       6,    34,    52,    44
};

static const yytype_uint8 yycheck[] =
{
      23,     9,    25,     0,     3,     4,    12,    21,    22,    20,
       3,     4,    35,    12,    21,    38,    22,    10,    11,    12,
      13,    20,    13,    46,    47,    48,    49,    20,     3,     4,
      12,    18,    19,     4,    16,    17,    18,    19,    15,    62,
      20,    15,    12,     5,    12,    20,    16,    17,    18,    19,
      16,    17,    18,    19,    12,    21,    16,    17,    18,    19,
      10,    21,    16,    17,    18,    19,     6,     7,     8,    14,
       0,    15,    37,    28
};
...
{
       0,     6,     7,     8,    24,    25,    26,     0,     9,    20,
      21,    13,    27,    26,    28,    30,    31,     4,    32,    33,
       3,     4,    10,    11,    12,    20,    27,    29,    35,    36,
      37,    38,    39,    40,    31,    15,    12,    22,    15,    20,
      12,    40,    40,    14,    36,    12,    16,    17,    18,    19,
      34,    40,    33,    40,     5,    12,    21,    40,    40,    40,
      40,    21,    22,    12,    40,    21,    12
};
...
#line 261 "test1.y"
    {
        (yyval.node) = create_node(AST_MAIN_FUNC, "main");
...
#line 272 "test1.y"
    {
        (yyval.node) = create_node(AST_TYPE_SPEC, "char");
    }
    break;
...
#line 281 "test1.y"
    {
        ...
        if ((yyvsp[(2) - (4)].node)) add_child((yyval.node), (yyvsp[(2) - (4)].node));
...
#line 318 "test1.y"
    {
        (yyval.node) = create_node(AST_DECL, NULL);
...
#line 326 "test1.y"
    {
        (yyval.node) = create_node(AST_INIT_LIST, NULL);
        add_child((yyval.node), (yyvsp[(1) - (1)].node));
    }
    break;
...
#line 337 "test1.y"
    {
        (yyval.node) = create_node(AST_INIT, NULL);
        add_child((yyval.node), create_node(AST_ID, (yyvsp[(1) - (1)].sval)));
    }
    break;
...
#line 341 "test1.y"
    {
        (yyval.node) = create_node(AST_INIT, NULL);
        add_child((yyval.node), create_node(AST_ID, (yyvsp[(1) - (3)].sval)));
        add_child((yyval.node), (yyvsp[(3) - (3)].node));
    }
    break;
...
#line 366 "test1.y"
    {
        (yyval.node) = create_node(AST_STMT, NULL);
        add_child((yyval.node), (yyvsp[(1) - (1)].node));
    }
    break;
...
#line 395 "test1.y"
    {
        (yyval.node) = create_node(AST_PRINTF_STMT, NULL);
        add_child((yyval.node), create_node(AST_STRING_LITERAL, (yyvsp[(3) - (7)].sval)));
...
#line 400 "test1.y"
    {
        (yyval.node) = create_node(AST_PRINTF_STMT, NULL);
        add_child((yyval.node), create_node(AST_STRING_LITERAL, (yyvsp[(3) - (5)].sval)));
    }
    break;
...
#line 417 "test1.y"
    {
        (yyval.node) = create_node(AST_EXPR, NULL);
        add_child((yyval.node), create_node(AST_ID, (yyvsp[(1) - (1)].sval)));
    }
    break;
...
#line 421 "test1.y"
    {
        ...
        (yyval.node) = create_node(AST_EXPR, NULL);
        add_child((yyval.node), create_node(AST_INT_LITERAL, buffer));
    }
    break;
...
#line 427 "test1.y"
    {
        ...
        add_child(binary, (yyvsp[(1) - (3)].node));
        add_child(binary, (yyvsp[(3) - (3)].node));
        add_child((yyval.node), binary);
    }
    break;
...
#line 455 "test1.y"
    {
        ...
        add_child(assign, create_node(AST_ID, (yyvsp[(1) - (3)].sval)));
        add_child(assign, (yyvsp[(3) - (3)].node));
